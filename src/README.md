...
Este proyecto corresponde a la actividad sumativa 1 de la Semana 3 de POO. Se trata de un sistema orientado a objetos desarrollado en Java, cuyo objetivo es modelar y gestionar las personas vinculadas a la agencia de turismo **Llanquihue Tour**, aplicando los principios de encapsulamiento, composición y herencia.
